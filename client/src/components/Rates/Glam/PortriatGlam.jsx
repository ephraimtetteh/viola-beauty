      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="mt-6 flex justify-between items-center">
                ...
                <button className="px-4 py-2 rounded-full bg-transparent  text-black border border-black hover:bg-black hover:text-white text-sm">
                  Book
                </button>
              </div>
            </motion.div>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-amber-50 border border-amber-100 text-center">
          ...
          <p className="text-gray-600 max-w-xl mx-auto text-sm leading-relaxed">
            ...
            <span className="font-medium"> shopviolabeauty@gmail.com </span>
            or WhatsApp
